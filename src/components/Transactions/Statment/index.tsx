...
export const Statment = () => {
  ...
  return (
    <div className="mt-5">
      <p className="mb-0 lead bold p-0">Transaction Statment</p>
      <div className="mdc-card info-card info-card--danger no-shadow overflow-x-auto mt-5 p-0">
        ...
        <img className="w-30 mr-3" alt="img-plus" src="/assets/images/ic-plus.svg" />   
        ...
        <div className="col-lg-6">
        <div className="row flex flex-row m-0">
        <img className="w-30 mr-3" alt="img-plus" src="/assets/images/ic-minus.svg" />   
        <p className="mr-3 pt-2">Expensis</p>
        <h4 className="pt-2">NGR 1952.68</h4>
        </div>
          </div>
</div>
<div className="card-inner row mb-0 d-flex">
  ...
  <tbody>
    <tr>
      ...
      <td> <img className="w-40 mr-3" alt="img-plus" src="/assets/images/icn-transfer.svg" />   </td>
      <td>+ ₦30,000</td>
    </tr>
    <tr>
      <td>02-07-2020</td>
    ...
    <tr>
      <td>02-07-2020</td>
      <td>Transfer to self</td>
      <td> <img className="w-40 mr-3" alt="img-plus" src="/assets/images/icn-airtime.svg" />   </td>
      <td>+ ₦30,000</td>
    </tr>
    <tr>
      <td>02-07-2020</td>
      <td>Transfer to self</td>
      <td> <img className="w-40 mr-3" alt="img-plus" src="/assets/images/icn-subscription.svg" />   </td>
      <td>+ ₦30,000</td>
    </tr>
  </tbody>
</Table>  
