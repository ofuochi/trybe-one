            ...
            <Row>
              ...
              <Card className="bd-0">
                ...
                <h3 className="card-title text-center">
                        ...
                        <p className="card-text">
                            Join the Trybe and learn exciting ways to make money monthly as well as how 
                            to invest the money you make wisely. Broke days are over!
                        </p>
                </Card.Body>
              </Card>
              </Col>
              ...
              <Card className="bd-0">
                ...
                <h3 className="card-title text-center">
                        ...
                        <p className="card-text">
                        Let’s take learning outside the lecture halls! We bring you up close with your favorite 
                            entrepreneurs, career mentors, celebrities, influencers more! We also give you access to
                             online courses and insightful articles for your journey to self-discovery and freedom.
                        </p>
                </Card.Body>
              </Card>
              </Col>
              ...
              <Card className="bd-0">
                ...
                <h3 className="card-title text-center">
                        ...
                        <p className="card-text">
                        What is life if you cannot enjoy yourself and have some fun? TrybeOne gives you access 
                            to the best events, venues and giveaways to keep you smiling.
            ...
            <Col data-aos="fade-up" className="about-image" lg="6" md="6" sm="6"></Col>
              ...
              <p className="card-text">
                        TrybeOne is the community that intersects between pop culture and finance, a world where you live
                         on your terms and you are free to be anyone you want to be. We are the coolest Gen–Z and Millennial
                          'geng', for Networking, Collaborating, Growth and Fun.
                    </p>

                    <h2 className="section-head">Tryber</h2>
                    <p  className="card-text">
                        A Tryber is an ambassador of the TrybeOne community <span>#FreeToBe</span>.
                    </p>
                    <Button className="btn btn-primary px-4 mt-4">
                            Join Trybe
                        </Button>
            ...
            <Row>
              ...
              <div className="card-text">
                <ul className="list-unset"><li>Community access to a network of like-minded GenZs</li>
                 ...
                 <li >Access to the coolest events (block parties, career fairs etc.)</li> 
                 <li >Access to skill acquisition programs, business management and advisory sessions.</li> 
